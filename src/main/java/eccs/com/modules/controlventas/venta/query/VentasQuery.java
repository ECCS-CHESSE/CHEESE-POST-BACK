...
public interface VentasQuery extends JpaRepository<CortesEntity, Long> {
    ...
    @Query(value = "SELECT * FROM \"controlventas\".fn_create_comprobante_venta(:id_eccs_sucursal, :id_eccs_cliente, :id_eccs_empleado, :id_eccs_tipo_comprobante)", nativeQuery = true)
    List<Map<String, Object>> getCrearVenta(
        ...
        @Param("id_eccs_tipo_comprobante") Integer id_eccs_tipo_comprobante
    );
